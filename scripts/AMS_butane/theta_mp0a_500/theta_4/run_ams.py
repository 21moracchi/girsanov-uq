...
device = 'cuda'
posterior_samples = np.load('../../../ams_runs_mp0a/pops/binary_data/posterior_samples_mp0a.npy')
theta = posterior_samples[:, theta_index]
calc = MACELinear(model_path=mace_model_path, device=device, default_dtype='float32', linear_weights=theta)
atoms.calc = calc
...
# Reuse initial conditions from ams_runs_mp0a_500/sample_ini_conds/ini_conds/i/.
